...
# I am explicitely defining all the types to reduce the number of anonymous R 
# named types that are generated by glue. 
...
# TODO investigate further, scrolling the column doesn't seem to do anything
# TODO investigate why scroll can crash the app
